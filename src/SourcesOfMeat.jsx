...
export default function SourcesOfMeat() {
  ...
  return (
    <>
      {/* 🔍 SEO Helmet */}
      <Helmet>
        <title>Sources of Meat | Plants Over Pain</title>
        <meta
          name="description"
          content="Explore where meat really comes from: factory farms, 'humane' labels, backyard coops, and why every path leads to suffering and slaughter."
        />
        <link rel="canonical" href="https://plantsoverpain.org/sourcesofmeat" />
      </Helmet>
      ...
      <div className="px-4 pt-10 pb-20 text-[#3a3a3a]">
        ...
        <section className="max-w-4xl mx-auto space-y-5">
          ...
          <article className="rounded-2xl border border-gray-200 bg-white/80 shadow-sm overflow-hidden">
            ...
            <div className="px-5 pb-3 text-[17px] leading-relaxed text-[#2f2f2f]">
              <p>
                ...
                hidden facilities designed to produce as much meat as possible,
                as cheaply as possible. Most people never see inside them.
            ...
            >
              <p className="mb-4">
                ...
                wings. Pigs stuck in crates so small they can’t even turn
                around. Cows living on concrete, hooked up to machines, treated
                like milk-making tools.
              </p>
              <p className="mb-4">
                Imagine living your entire life in a bathroom stall. Imagine
                never seeing the sun. Never feeling grass. Never being able to
                move freely. That’s daily reality for animals in factory farms.
              </p>
              <p className="mb-4">
                Many have parts of their bodies cut off to “save space” or stop
                them from attacking each other out of stress — beaks cut from
                baby chicks, tails chopped from piglets — all without
                painkillers. These aren’t rare exceptions. They’re normal.
              </p>
              <p className="mb-0">
                Even the animals themselves have been changed. Chickens are bred
                to grow so fast their bones break. Cows are forced to produce
                far more milk than their bodies can handle. It’s not about
                what’s natural — it’s about what makes the most money.
                <br />
                <br />
          ...
          <article className="rounded-2xl border border-gray-200 bg-white/80 shadow-sm overflow-hidden">
            ...
            <div className="px-5 pb-3 text-[17px] leading-relaxed text-[#2f2f2f]">
              <p>
                Some meat is marketed as “free-range,” “organic,” or “humane.”
                The truth is different. Besides, how humane is killing?
              </p>
            </div>
            ...
            >
              <p className="mb-4">
                Imagine a farm ad: green pastures, smiling farmers, animals
                living their “best lives.” Now compare that to the reality. On
                most so-called “humane” farms, animals still live in crowded
                barns, are separated from their families, and are sent to the
                same slaughterhouses as factory-farmed animals. The only real
                difference? The label—and the price tag.
              </p>
              <p className="mb-4">
                Labels like “free-range” and “organic” sound comforting, but
                they often mask the same harsh realities. Many “free-range”
                animals still spend most of their lives indoors. “Pasture-raised”
                often means limited outdoor access. And while the conditions may
                be less extreme than factory farms, the end is the same.
              </p>
              <p className="mb-0">
                ...
                fraction of their natural lifespan. Whether it’s a gas chamber
                for pigs or a bolt gun to the head for cows, killing is never
          ...
          <article className="rounded-2xl border border-gray-200 bg-white/80 shadow-sm overflow-hidden">
            ...
            <div className="px-5 pb-3 text-[17px] leading-relaxed text-[#2f2f2f]">
              <p>
                ...
                more personal, even compassionate. But behind the cozy imagery,
                the same pattern remains: animals are used, exploited, and
                killed.
              </p>
            </div>
            ...
            >
              ...
              <p className="mb-4">
                Many people raise backyard chickens with affection. They name
                them, feed them scraps, give them room to roam. But when egg
                production slows or the holidays come around, kindness often
                turns into slaughter. The same animal, just a different day.
              </p>
              <p className="mb-4">
                We tell ourselves it’s different when it’s “local.” But local
                doesn’t mean painless. Familiarity doesn’t erase fear. And
                proximity doesn’t undo exploitation. Even small-scale farms rely
                on the same core idea: that animals exist for our use.
              </p>
              <p className="mb-0">
                Personal care doesn’t cancel out structural harm. It just hides
                it behind a friendlier face. If we’re serious about compassion,
                it shouldn’t stop at scale — it should challenge the very idea
                of killing animals we claim to care about.
              </p>
              <div className="mt-4">
                <button
                  onClick={() => toggle("backyard")}
          ...
          <article className="rounded-2xl border border-gray-200 bg-white/80 shadow-sm overflow-hidden">
            ...
            >
              <p className="mb-4">
                ...
                have their throats slit by hand. It doesn’t matter how nicely
                they were raised, how organic their feed was, or how green the
                pasture looked. They all meet the same blade.
              </p>
              <p className="mb-4">
                These animals aren’t signing up for this. They don’t walk
                willingly into slaughterhouses. They struggle. They resist. They
                want to live — just like the dogs we adore or the cats we cradle
                at night.
              </p>
              <p className="mb-0">
                We often tell ourselves it’s “just how nature works,” or “they
                had a good life.” But a good life doesn’t make an unjust death
                fair. Especially when that death exists purely for our
                convenience, our habits, or our taste preferences.
                <br />
                <br />
                So we have to ask ourselves: Is taste really a good enough
                reason? Is a few minutes of flavor on our tongues worth a
                lifetime taken from someone else?
                <br />
                <br />
                Because no matter how the story begins — big farm, small farm, or
                backyard coop — it always ends the same. And that ending
