...
export default function Arguments() {
  ...
  return (
    <>
      {/* 🔍 SEO Helmet */}
      <Helmet>
        <title>Vegan Arguments & Responses | Plants Over Pain</title>
        <meta
          name="description"
          content="Explore vegan arguments and clear responses to common questions and misconceptions. Filter by topic and perspective for ethical, practical, and factual insights."
        />
